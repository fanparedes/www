...
?>
	...
	<div class="container">
        ...
        <div class="bloque-podio">
            <div class="intro">
                <h2>Sectores de la economía</h2>
                <p>Datos de interés sobre sectores de la economía en el país</p>
            </div>
        </div>
            ...
            <div class="col-12 col-md-6">
                <div class="bloque-icono">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="icono">
                                <a href="<?php echo get_site_url().'/sector-detalle/4/';?>" class="icon-plus"><i class="fal fa-plus"></i></a>    
                                <i class="iconcl-crecimiento-xl"></i>
                            </div>
                            <div class="text">
                                <span class="title">Industias Manufactureras</span>
                    ...
                    <div class="col-12 col-md-6 item">
                        <div class="bloque-indicador">
                            <div class="grafica-circulo">
                                ...
                                <a href="<?php echo get_site_url().'/ocupacion-detalle/2131/?code_job_position=2529X';?>" class="icon-plus"><i class="fal fa-plus"></i></a>
                                <a href="<?php echo get_site_url().'/ocupacion-detalle/2131/?code_job_position=2529X';?>">
                            ...
                            <div class="text">
				<a href="<?php echo get_site_url().'/ocupacion-detalle/2131/?code_job_position=2529X';?>" class="title"><i class="fal fa-plus"></i>Especialista en ciberseguridad</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 item">
                        <div class="bloque-indicador">
                            <div class="grafica-circulo">
                                ...
                                <a href="<?php echo get_site_url().'/ocupacion-detalle/3413/?code_job_position=4-41.30';?>" class="icon-plus"><i class="fal fa-plus"></i></a>
                                <a href="<?php echo get_site_url().'/ocupacion-detalle/3413/?code_job_position=4-41.30';?>">
                            ...
                            <div class="text">
				<a href="<?php echo get_site_url().'3413/?code_job_position=4-41.30';?>" class="title"><i class="fal fa-plus"></i>Agente Inmobiliario</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 item">
                        <div class="bloque-indicador">
                            <div class="grafica-circulo">
                                ...
                                <a href="<?php echo get_site_url().'/ocupacion-detalle/2419/?code_job_position=2431X';?>" class="icon-plus"><i class="fal fa-plus"></i></a>
                                <a href="<?php echo get_site_url().'/ocupacion-detalle/2419/?code_job_position=2431X';?>">
                            ...
                            <div class="text">
				<a href="<?php echo get_site_url().'/ocupacion-detalle/2419/?code_job_position=2431X';?>" class="title"><i class="fal fa-plus"></i>Especialista en Marketing Digital</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row owl-desktop">
                    <div class="col-4 owl-desktop">
                        <div class="bloque-indicador">
                            ...
                            <div class="text">
                                <a href="<?php echo get_site_url().'/ocupacion-detalle/2131/?code_job_position=2529X';?>" class="title">Especialista en ciberseguridad</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-4 owl-desktop">
                        <div class="bloque-indicador">
                            ...
                            <div class="text">
                                <a href="<?php echo get_site_url().'/ocupacion-detalle/3413/?code_job_position=4-41.30';?>" class="title">Agente Inmobiliario</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-4 owl-desktop">
                        <div class="bloque-indicador">
                            ...
                            <div class="text">
                                <a href="<?php echo get_site_url().'/ocupacion-detalle/2419/?code_job_position=2431X';?>" class="title">Especialista en Marketing Digital</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!--<div class="col-12">
                <div class="banner-col-12 banner-transformacion">
                    <div class="content">
                        ...
                        <p>Prepárate para las ocupaciones digitales encontrando la formación que necesitas para las habilidades más demandadas del sector.</p>
            ...
            <div class="col-12">
                <div class="banner-col-12 banner-destino-empleo">
                    <div class="content"> 
                        ...
                        <a href="https://www.chilevalora.cl/centro-de-ayuda/" class="btn btn-yellow">Consultar ayuda</a> 
                    </div>    
                </div>
            </div>
            <!-- FIN BANNER -->
