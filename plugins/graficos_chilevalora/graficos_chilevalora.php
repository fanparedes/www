...
function menuGrafico(){
	add_menu_page( 'grafico_load', 'Gráficos Chilevalora', 'read', 'grafico_load', 'grafico_load', 'dashicons-chart-line');
}
...
function my_enqueue_script_admin( $hook ) {
	...
	//
	wp_enqueue_script('ajax_plugin', plugin_dir_url(dirname(__FILE__)) . '/graficos_chilevalora/js/ajax_plugin.js', array('highcharts_sankey'), '3.3.4');
